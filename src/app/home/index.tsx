  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.subtitle}>Falta 28 dias para a sua viagem</Text>
      </ImageBackground>
      ...
      <View style={styles.ticket}>
        <View style={styles.content}>
          ...
          <Text style={styles.name}>Raisa AAA </Text>

          <View style={styles.details}>
            <View style={styles.inline}>
              <Info label="Data" value="25 de Nov." />
              <Info label="Embarque" value="17:30" />
            </View>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <View style={styles.footerContent}>
            <View style={styles.inline}>
              ...
              <Info label="Assento" value="35G" />
            </View>

            <View style={styles.inline}>
              <Info label="Termial" value="3" />
              <Info label="Portão" value="42" />
            </View>
          </View>
